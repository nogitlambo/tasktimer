      ...
      <div className="modal" role="dialog" aria-modal="true" aria-label="Edit Task">
        <div className="editTaskModalFrame">
          ...
          <div className="editTaskModalBody">
            ...
            <div className="taskScheduleFields" id="editTaskScheduleFields">
              ...
              <div className="field editPlannedStartDateField">
                <label htmlFor="editPlannedStartDateInput">Planned Start Date</label>
                <input id="editPlannedStartDateInput" className="plannedStartDateInput" type="date" aria-label="Edit planned start date" />
              </div>

              <div className="field editPlannedStartField">
                <label htmlFor="editPlannedStartTimeInput">Planned Start Time</label>
          ...
          <div className="footerBtns">
            <button className="btn btn-ghost modalPreviewSecondaryAction primitiveSciFiModalAction primitiveSciFiModalSecondaryAction editTaskPrimitiveAction editTaskPrimitiveSecondaryAction" id="cancelEditBtn" type="button">
              Cancel
            </button>
            <button className="btn btn-accent modalPreviewPrimaryAction primitiveSciFiModalAction primitiveSciFiModalPrimaryAction editTaskPrimitiveAction editTaskPrimitivePrimaryAction" id="saveEditBtn" type="button">
              Save
            </button>
          </div>
