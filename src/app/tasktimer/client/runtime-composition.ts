...
export function createTaskTimerRuntimeComposition(
  ...
  const preferencesState = createTaskTimerMutableStore({
    ...
    executiveFunctionEnabled: (cloudPreferencesCache || preferencesPersistence.loadResolved()).executiveFunctionEnabled !== false,
    ...
    achievementSoundsEnabled: initialState.achievementSoundsEnabled,
  ...
  const sessionRuntimeState = createTaskTimerMutableStore({
    ...
    checkpointFlashUntilMsByTaskId: initialState.checkpointFlashUntilMsByTaskId,
