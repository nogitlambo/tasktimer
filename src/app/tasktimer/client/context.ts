...
export type TaskTimerRewardsHistoryContext = {
  ...
  saveLiveSession: (session: LiveTaskSession, opts?: { forceCloudFlush?: boolean; reason?: string }) => void;
...
export type TaskTimerGroupsContext = {
  ...
  getFriendEmailByUid: () => Record<string, string>;
  setFriendEmailByUid: (value: Record<string, string>) => void;
...
export type TaskTimerAddTaskContext = TaskTimerBindingsContext & {
  ...
  getOptimalProductivityEndTime: () => string;
  getOptimalProductivityDays: () => OptimalProductivityDays;
  getAddTaskWizardStep: () => 1 | 2 | 3 | 4 | 5;
  setAddTaskWizardStepState: (value: 1 | 2 | 3 | 4 | 5) => void;
  getAddTaskType: () => "recurring" | "once-off" | null;
  setAddTaskTypeState: (value: "recurring" | "once-off" | null) => void;
  getAddTaskOnceOffDay: () => "mon" | "tue" | "wed" | "thu" | "fri" | "sat" | "sun";
  setAddTaskOnceOffDayState: (value: "mon" | "tue" | "wed" | "thu" | "fri" | "sat" | "sun") => void;
  getAddTaskPlannedStartDate: () => string;
  setAddTaskPlannedStartDateState: (value: string) => void;
...
export type TaskTimerDashboardRenderContext = {
  ...
  getActivityGoalSnapshotsByDay: () => Record<string, number>;
  setActivityGoalSnapshotsByDay: (value: Record<string, number>) => void;
  getDashboardTimelineDensity: () => DashboardTimelineDensity;
  setDashboardTimelineDensity: (value: DashboardTimelineDensity) => void;
