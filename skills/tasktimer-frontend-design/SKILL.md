...
description: Apply the TaskTimer app's existing frontend visual language (dark neon productivity UI, square controls, app fonts, #0d0f13 primary surfaces, existing button classes, and primary-theme styling). Use when creating or modifying TaskTimer pages, modals, charts, panels, or controls so new UI matches current styling and interaction patterns.
---
...
- For quick reusable snippets/patterns (modal skeletons, icon button states, primary-theme notes), read `references/tasktimer-style-notes.md`.
...
- Keep button-like controls square and use the existing button classes.
- Use the primary accent tokens for primary/active states.
...
- Keep new component styles aligned with the primary theme path.
...
- Edit Task modal uses the same app background and square modal styling.
...
- Kept new UI styles aligned with the primary theme
